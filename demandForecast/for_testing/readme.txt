demandForecast MATLAB .NET Assembly (.NET Component)
...
demandForecast_overview.html - HTML overview documentation file for the generated 
                               component. It contains the requirements for accessing the 
                               component and for generating arguments using the MWArray 
                               class hierarchy.

demandForecast.xml - This file contains the code comments for the demandForecast 
                               ...
                               documentation for the demandForecast component.
